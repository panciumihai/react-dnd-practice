...
import type { EventName, TouchBackendContext, TouchBackendOptions } from './interfaces.js';
...
export class TouchBackendImpl implements Backend {
  ...
  // Custom states
  public handleTopMoveRaf: any;
  public handleTopMoveCaptureRaf: any;
  ...
  public setup(): void {
    ...
    this.addEventListener(root, 'start', this.handleTopMoveStartCapture as any, true);
    this.addEventListener(root, 'move', this.handleTopMove as any);
    this.addEventListener(root, 'move', this.handleTopMoveCapture, true);
    this.addEventListener(root, 'end', this.handleTopMoveEndCapture as any, true);

    if (this.options.enableMouseEvents && !this.options.ignoreContextMenu) {
      this.addEventListener(root, 'contextmenu', this.handleTopMoveEndCapture as any);
    }

    if (this.options.enableKeyboardEvents) {
      this.addEventListener(root, 'keydown', this.handleCancelOnEscape as any, true);
    }
  }
  ...
  public teardown(): void {
    ...
    this.removeEventListener(root, 'start', this.handleTopMoveStartCapture as any, true);
    ...
    this.removeEventListener(root, 'end', this.handleTopMoveEndCapture as any, true);

    if (this.options.enableMouseEvents && !this.options.ignoreContextMenu) {
      this.removeEventListener(root, 'contextmenu', this.handleTopMoveEndCapture as any);
    }

    if (this.options.enableKeyboardEvents) {
      this.removeEventListener(root, 'keydown', this.handleCancelOnEscape as any, true);
    }
  ...
  public handleMove = (_evt: MouseEvent | TouchEvent, targetId: string): void => {
  ...
  public handleTopMove = (e: TouchEvent | MouseEvent): void => {
    const update = (): void => {
      ...
      const sourceNode = this.sourceNodes.get(this.monitor.getSourceId() as string);
